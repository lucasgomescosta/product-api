...
import com.java.back.end.service.ProductService;
...
public class ProductController {
	...
	/**
	 * @Valid quando a rota /product for chamada, as validações definidas na classe
	 *        ProductDTO devem ser feitas. Se essa anotação não for adicionada,
